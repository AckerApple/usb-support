...
exports.getGameControllerByMeta = exports.listenToDeviceByMeta = void 0;
...
function listenToDeviceByMeta(deviceMeta) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            gameController = getGameControllerByMeta(deviceMeta);
            gameController.listen();
            return [2 /*return*/, gameController.paramIdle()];
        });
    });
}
exports.listenToDeviceByMeta = listenToDeviceByMeta;
function getGameControllerByMeta(deviceMeta) {
